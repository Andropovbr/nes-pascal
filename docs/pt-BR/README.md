...
- [x] `docs/language/records.md` -> `docs/pt-BR/language/records.md`
...
- [x] `docs/language/functions.md` -> `docs/pt-BR/language/functions.md`
...
- [x] `docs/compiler/index.md` -> `docs/pt-BR/compiler/index.md`
