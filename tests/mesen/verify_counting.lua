...
local function validateCountingResult()
    ...
    elseif not expectByte(0x0081, 0x10, "Sum") then
        return
    elseif not expectByte(0x0300, 0x03, "Index") then
        return
    elseif not expectByte(0x0301, 0x00, "Reverse") then
        return
    elseif not expectByte(0x0302, 0x00, "Edge") then
        return
    elseif not expectByte(0x0303, 0x01, "Outer") then
        return
    elseif not expectByte(0x0304, 0x01, "Inner") then
        return
