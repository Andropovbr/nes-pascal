...
parameter_Initialize_Start: .res 1      ; Start: byte parameter for Initialize
parameter_Initialize_Step: .res 1      ; Step: byte parameter for Initialize
parameter_Initialize_EnabledValue: .res 1      ; EnabledValue: boolean parameter for Initialize
parameter_ApplyStep_Amount: .res 1      ; Amount: byte parameter for ApplyStep
parameter_ApplyStep_ShouldApply: .res 1      ; ShouldApply: boolean parameter for ApplyStep
parameter_SelectColor_Matches: .res 1      ; Matches: boolean parameter for SelectColor
