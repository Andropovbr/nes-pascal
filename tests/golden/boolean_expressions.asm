...
variable_Equal: .res 1       ; Equal: boolean
variable_Different: .res 1       ; Different: boolean
variable_Less: .res 1       ; Less: boolean
variable_Greater: .res 1       ; Greater: boolean
variable_LessOrEqual: .res 1       ; LessOrEqual: boolean
variable_GreaterOrEqual: .res 1       ; GreaterOrEqual: boolean
variable_Combined: .res 1       ; Combined: boolean
