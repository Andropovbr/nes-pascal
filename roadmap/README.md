...
- **Last completed milestone:** [`0.5.6 — Builtin / Intrinsic Infrastructure`](0.md#builtin--intrinsic-infrastructure)
- **Next milestone:** [`0.5.7 — Low-Risk Code Generation Improvements`](0.md#low-risk-code-generation-improvements)
- **Next milestone file:** [Version 0 roadmap](0.md#low-risk-code-generation-improvements)
