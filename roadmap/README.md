...
- **Last completed milestone:** [`0.5.3 — Metasprites`](0.md#metasprites)
- **Next milestone:** [`0.5.4 — Sprite Animation`](0.md#sprite-animation)
- **Next milestone file:** [Version 0 roadmap](0.md#sprite-animation)
